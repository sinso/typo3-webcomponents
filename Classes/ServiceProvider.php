...
class ServiceProvider extends AbstractServiceProvider
{
    ...
    /**
     * @param \ArrayObject<int, string> $typoScriptArrayObject
    ...
    {
        if (
            !class_exists(ContentBlockRegistry::class)
            || !class_exists(TableDefinitionCollection::class)
            || !class_exists(ContentType::class)
        ) {
...
tt_content.{$typeDefinition->getTypeName()} = WEBCOMPONENT_CONTENTBLOCK
